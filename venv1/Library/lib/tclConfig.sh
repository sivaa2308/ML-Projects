...
# installed.
TCL_PREFIX='C:/ML_End_to_End_project/proj1/venv1\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='C:/ML_End_to_End_project/proj1/venv1\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='C:/ML_End_to_End_project/proj1/venv1\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IC:/ML_End_to_End_project/proj1/venv1\Library\include'
...
TCL_PACKAGE_PATH='C:/ML_End_to_End_project/proj1/venv1\Library\lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LC:/ML_End_to_End_project/proj1/venv1\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='C:/ML_End_to_End_project/proj1/venv1\Library\lib\tclstub86.lib'
